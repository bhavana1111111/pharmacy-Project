		...
		<div class="col-md-12">
			<div class="box">
				<div class="box-header">
					<center><h2>Contact Us</h2><p class="text-muted">
						If you have any questions, feel free to contact us, Our customer service center is working for you 24/7.
					</p></center>
				</div><!--box header end-->
				<form action="contactus.php" method="post"><div class="form-group">
					<label>Name</label>
...
<?php
	if (isset($_POST['submit'])) {
		...
		$recieverEmail="bhandaribhavna98@gmail.com";
		mail($recieverEmail, $senderName, $senderSubject, $senderMessage, $senderEmail);
		$email=$_POST['email'];
		$subject="Welcome to our website";
		$msg="I shall get you soon, Thank you for sending email";
		$from="bhandaribhavna98@gmail.com";
