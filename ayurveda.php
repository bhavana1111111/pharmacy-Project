	...
	<div class="container">
		...
		<div class="row">
			...
			if(!isset($_GET['p_cat']))
			{
				...
				$get_product="select * from products where cat_id=2 order by 1 DESC LIMIT $start_from, $per_page";
		...
		<center>
			<ul class="pagination">
				...
				{
					echo "<li><a href='ayurveda.php?page=".$i."'>".$i."</a></li>";
				};
				echo "<li><a href='ayurveda.php?page=$total_pages'>". 'Last Page'."</a></li>";
				}
			}
				?>
			</ul>
