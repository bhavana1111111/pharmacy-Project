	...
	<div class="container">
		...
		<div class="row">
			...
			if(!isset($_GET['p_cat']))
			{
				...
				$get_product="select * from products where cat_id=11 order by 1 DESC LIMIT $start_from, $per_page";
		...
		<center>
			<ul class="pagination">
				<?php
				$query="select * from products where cat_id=11";
				...
				{
					echo "<li><a href='personal_care.php?page=".$i."'>".$i."</a></li>";
				};
				echo "<li><a href='personal_care.php?page=$total_pages'>". 'Last Page'."</a></li>";
				}
			}
				?>
			</ul>
