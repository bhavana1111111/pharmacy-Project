...
<div id="content">
	<div class="container">
		...
		<div class="col-md-3">
			<?php
				include("includes/sidebar_nv.php");
			?>
		</div>
		<div class="col-md-9">
		<div class="row">
			...
			if(!isset($_GET['p_cat']))
			{
				...
				$get_product="select * from products where cat_id=6 order by 1 DESC LIMIT $start_from, $per_page";
		...
		<center>
			<ul class="pagination">
				<?php
				$query="select * from products where cat_id=6";
				...
				{
					echo "<li><a href='nutri_vit.php?page=".$i."'>".$i."</a></li>";
				};
				echo "<li><a href='nutri_vit.php?page=$total_pages'>". 'Last Page'."</a></li>";
				}
			}
				?>
			</ul>
