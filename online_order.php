...
<?php
	...
	while ($row_cart=mysqli_fetch_array($run_cart)) {
		...
		while ($row_pro=mysqli_fetch_array($run_pro)) {
			...
			$insert_cust="insert into pending_order (customer_id, product_id, product_title, due_amount, invoice_no, qty, order_date, order_status)
			...
			echo "<script>window.open('ship_on.php?','_self')</script>";
		}
	}
?>